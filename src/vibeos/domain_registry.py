...
def default_domain_registry(known_verifier_ids: tuple[str, ...]) -> DomainRegistry:
    ...
    packs = (
        DomainPack(
            ...
            policy_defaults={"list": "L0", "open": "L1"},
            default_verifier_ids=(),
        ...
        DomainPack(
            ...
            policy_defaults={"list": "L0", "focus": "L1", "minimize": "L1", "maximize": "L1", "close": "L2"},
            default_verifier_ids=(),
            optional_fallback_domain_ids=(),
        ),
        DomainPack(
        ...
        DomainPack(
            ...
            policy_defaults={"open_url": "L1", "search_web": "L1"},
        ...
        DomainPack(
            ...
            policy_defaults={"play": "L1", "pause": "L1"},
            default_verifier_ids=("media_playback_state_available",),
